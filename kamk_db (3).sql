...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 25 mars 2026 à 14:29
...
(1, 'SOULEIMAN', 'Kad', 'abdirachidhochkadar@gmail.com', '+25377020761', '$2y$12$VyJKjhrc4Wi7wQXJkzATiul/4P9aNUpFogt/sI3f1mU2QtaXqyMCi', 'Djibouti,balbala', 'Djibouti', NULL, 'Djiboutienne', 'B', 'uploads/profils/photo_69ba658fedc262.71142947.jpg', 0, 'Bronze', 1, 1, 'valide', NULL, NULL, NULL, 0, 0, NULL, 1, '2026-03-25 17:18:38', 'fr', 1, 1, '2026-03-13 14:52:17', '2026-03-25 14:18:38', NULL, NULL, NULL, 0),
...
(1, 1, 'KAMK', 'Administrateur', 'admin@kamk.dj', '+253 21 35 00 00', '$2y$12$GdmM/kofnLBy1tuzT4G3oOiEUmveO9CtJvivHLK7W3KTq6PEhS25K', 'admin', 'KAMK-ADM-001', '2026-01-01', NULL, 'uploads/profils/photo_69b67206059ac9.84869479.jpg', 1, 0, '2026-03-24 23:04:37', NULL, '2026-03-11 20:29:45', '2026-03-24 20:04:37'),
(2, 1, 'HASSAN', 'Ali', 'contrat@kamk.dj', '+25377000010', '$2y$12$GdmM/kofnLBy1tuzT4G3oOiEUmveO9CtJvivHLK7W3KTq6PEhS25K', 'contrat', 'KAMK-CON-001', '2026-03-14', NULL, 'uploads/profils/photo_69b577f2d1c835.44479414.jpg', 1, 0, '2026-03-25 17:18:27', NULL, '2026-03-14 11:39:38', '2026-03-25 14:18:34'),
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Journal complet des actions';
...
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Notifications in-app, email et SMS';
...
(6, NULL, 2, '📋 Nouvelle réservation !', 'Kad SOULEIMAN demande le Toyota Land Cruiser du 17/03/2026 au 20/03/2026.', 'alerte', 'app', 1, 'dashboard_employe.php', 0, NULL, '2026-03-14 12:37:50'),
...
(16, NULL, 2, '📋 Nouvelle réservation !', 'Ayman RAMZI demande le Mercedes Sprinter Cargo du 16/03/2026 au 18/03/2026.', 'alerte', 'app', 1, 'dashboard_employe.php', 0, NULL, '2026-03-14 23:23:37'),
...
(22, NULL, 2, '📋 Nouvelle réservation à traiter', 'Kad SOULEIMAN — Scott Sub Sport 20 — du 15/03/2026 au 16/03/2026 — 26 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-15 12:15:40'),
...
(24, NULL, 2, '💬 Message de Kad SOULEIMAN — Sur ma reservation', 'Salam, ma demande est traiter ?', 'info', 'app', 1, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-16 16:38:36'),
...
(26, NULL, 2, '💬 Message de Kad SOULEIMAN — Sur ma reservation', 'Salam, ma demande est traiter ?', 'info', 'app', 1, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-16 16:38:41'),
...
(29, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00001 — 7.8$ via carte — Réf: PAY-AAF9950182', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-19 21:58:45'),
...
(31, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00001 — 7.8$ via carte — Réf: PAY-4AA52BDF87', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-19 21:58:52'),
...
(38, NULL, 2, '📋 Nouvelle réservation à traiter', 'Kad SOULEIMAN — Volkswagen Jetta — du 22/03/2026 au 25/03/2026 — 195 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-20 19:12:29'),
...
(41, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00001 — 58.5$ via carte — Réf: PAY-65C0C0F9BF', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-20 19:15:11'),
...
(51, NULL, 2, '📋 Nouvelle réservation à traiter', 'Hoch ABDIRACHID — Skoda Superb — du 22/03/2026 au 25/03/2026 — 375 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-21 16:27:56'),
(52, NULL, 2, '🚫 Annulation client', 'Client KAMK-00001 — Réservation #4 — Aucun remboursement', 'alerte', 'app', 1, NULL, 0, NULL, '2026-03-21 18:33:10'),
...
(56, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00011 — 112.5$ via carte — Réf: PAY-A7E4A527E9', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-21 19:48:34'),
(57, NULL, 2, '🔄 Retour véhicule demandé — Kad SOULEIMAN', 'Le client KAMK-00001 souhaite restituer son véhicule. ⚠️ Retard : 30h (+320$).', 'alerte', 'app', 1, 'dashboard_employe.php?page=retour_vehicule', 0, NULL, '2026-03-21 22:29:53'),
...
(64, NULL, 2, '📋 Nouvelle réservation à traiter', 'Moubarak MR — Ford Fiesta — du 22/03/2026 au 23/03/2026 — 55 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-22 12:22:36'),
...
(67, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00012 — 16.5$ via carte — Réf: PAY-BDBFE6CBAA', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-22 12:27:48'),
...
(73, NULL, 2, '📋 Nouvelle réservation à traiter', 'Hoch ABDIRACHID — Volkswagen Jetta — du 22/03/2026 au 23/03/2026 — 60 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-22 13:52:06'),
...
(76, NULL, 2, '📋 Nouvelle réservation à traiter', 'Hoch ABDIRACHID — Cannondale Quick 4 — du 23/03/2026 au 24/03/2026 — 26 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-22 13:56:16'),
...
(79, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00011 — 7.8$ via carte — Réf: PAY-3DBDDBE20E', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-22 13:59:08'),
...
(81, 11, NULL, '📋 Demande de réservation reçue', 'Bonjour Hoch, votre demande pour le Toyota Corolla du 24/03/2026 au 25/03/2026 est en cours de traitement. Un employé KAMK la confirmera sous 24h et vous enverra les informations de paiement.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-23 10:07:56'),
(82, NULL, 2, '📋 Nouvelle réservation à traiter', 'Hoch ABDIRACHID — Toyota Corolla — du 24/03/2026 au 25/03/2026 — 133 $', 'alerte', 'app', 1, 'dashboard_employe.php?page=reservations', 0, NULL, '2026-03-23 10:07:56'),
(83, 11, NULL, '⏰ Acompte requis — 39.9 $', 'Bonjour Hoch, votre réservation du Toyota Corolla nécessite un acompte de 39.9$ (30%). Connectez-vous pour payer dans les 48h.', 'alerte', 'app', 1, NULL, 0, NULL, '2026-03-23 10:09:14'),
(84, 11, NULL, '💰 Paiement en vérification', 'Votre paiement de 39.9$ (réf: PAY-231D36A6D4) est en cours de vérification. Confirmation sous 24h.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-23 10:11:42'),
(85, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00011 — 39.9$ via carte — Réf: PAY-231D36A6D4', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-23 10:11:42'),
(86, 11, NULL, '❌ Paiement refusé', 'Votre paiement de 39.90$ a été refusé. Motif : cuz u are a pieace of shiit. Veuillez réessayer ou contacter l\'agence.', 'alerte', 'app', 1, NULL, 0, NULL, '2026-03-23 10:40:05'),
(87, 1, NULL, '💰 Paiement en vérification', 'Votre paiement de 7.8$ (réf: PAY-33D377104E) est en cours de vérification. Confirmation sous 24h.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-23 19:48:44'),
(88, NULL, 2, '💰 Nouveau paiement à valider', 'Client KAMK-00001 — 7.8$ via carte — Réf: PAY-33D377104E', 'succes', 'app', 1, NULL, 0, NULL, '2026-03-23 19:48:44'),
(89, NULL, 2, '💬 Message de Kad SOULEIMAN — Message client', 'hello', 'info', 'app', 1, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-23 22:12:39'),
(90, 1, NULL, '[MSG] 👤 Kad SOULEIMAN : Message client', 'hello', 'info', 'messagerie', 1, NULL, 0, NULL, '2026-03-23 22:12:39'),
(91, 1, NULL, '📤 Message envoyé : Message client', 'Votre message a été transmis au service contrat. Réponse sous 24h.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-23 22:12:39'),
(92, NULL, 2, '💬 Message de Kad SOULEIMAN — Message client', 'Hey', 'info', 'app', 1, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-24 12:28:03'),
(93, 1, NULL, '[MSG] 👤 Kad SOULEIMAN : Message client', 'Hey', 'info', 'messagerie', 1, NULL, 0, NULL, '2026-03-24 12:28:03'),
(94, 1, NULL, '📤 Message envoyé : Message client', 'Votre message a été transmis au service contrat. Réponse sous 24h.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-24 12:28:03'),
(95, NULL, 2, '💬 Message de Kad SOULEIMAN — Message client', 'Hey', 'info', 'app', 1, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-24 12:28:14'),
(96, 1, NULL, '[MSG] 👤 Kad SOULEIMAN : Message client', 'Hey', 'info', 'messagerie', 1, NULL, 0, NULL, '2026-03-24 12:28:14'),
(97, 1, NULL, '📤 Message envoyé : Message client', 'Votre message a été transmis au service contrat. Réponse sous 24h.', 'info', 'app', 1, NULL, 0, NULL, '2026-03-24 12:28:14'),
(98, 11, NULL, 'Message de l administration KAMK', 'Salam, veuillez envoyer vos identifiants !', 'info', 'messagerie', 0, NULL, 0, NULL, '2026-03-24 19:56:06'),
(99, NULL, 1, '💬 Message de Hoch ABDIRACHID — Message client', 'de connexion ?', 'info', 'app', 0, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-24 19:56:34'),
(100, 11, NULL, '[MSG] 👤 Hoch ABDIRACHID : Message client', 'de connexion ?', 'info', 'messagerie', 0, NULL, 0, NULL, '2026-03-24 19:56:34'),
(101, 11, NULL, '📤 Message envoyé : Message client', 'Votre message a été transmis au service admin. Réponse sous 24h.', 'info', 'app', 0, NULL, 0, NULL, '2026-03-24 19:56:34'),
(102, NULL, 1, '💬 Message de Hoch ABDIRACHID — Message client', 'de connexion ?', 'info', 'app', 0, 'dashboard_employe.php?page=messagerie', 0, NULL, '2026-03-24 19:56:40'),
(103, 11, NULL, '[MSG] 👤 Hoch ABDIRACHID : Message client', 'de connexion ?', 'info', 'messagerie', 0, NULL, 0, NULL, '2026-03-24 19:56:40'),
(104, 11, NULL, '📤 Message envoyé : Message client', 'Votre message a été transmis au service admin. Réponse sous 24h.', 'info', 'app', 0, NULL, 0, NULL, '2026-03-24 19:56:40'),
(105, NULL, 2, 'Annulation client', 'Client KAMK-00001 — Resa #3 annulée. Raison : Malade depuis des années. Aucun remboursement.', 'alerte', 'app', 1, NULL, 0, NULL, '2026-03-24 20:06:25'),
(106, 1, NULL, 'Réservation annulée', 'Réservation annulée. Aucun remboursement applicable (delai dépasse 48h).', 'info', 'app', 1, NULL, 0, NULL, '2026-03-24 20:06:25');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Paiements et encaissements';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Réservations de véhicules';
